...
2.  **Source Layout:** Rename `src/` to `src/ainpp/` and update all internal imports.
...
- [x] Phase 1: Setup & Packaging
    ...
    - [x] 1.2 Migrate to src/ainpp/ layout
...
- [x] `from ainpp.models import ...` works from any directory.
...
- [2026-02-25] Created pyproject.toml and migrated to src/ainpp/ layout.
- [2026-02-25] Updated all imports to ainpp. namespace.
...
### Completion Notes
- Package `ainpp` is now installable and follows standard SRC layout.
- Visualization logic moved to `ainpp.visualization.samples`.
