...
class ConvLSTMCell(nn.Module):
    """
    Célula ConvLSTM - processa um timestep mantendo estrutura espacial. 
    """
    def __init__(
            self, 
            input_channels: int, 
        ...
        # Convolução combinada para todas as gates (i, f, o, g)
        self.conv = nn.Conv2d(
    ...
    def forward(
        ...
        Args:
            ...
            hidden_state: tuple (h, c) onde h e c são (B, C_hidden, H, W)
        Returns:
            h_next, c_next: próximos estados hidden e cell
        """
        h_cur, c_cur = hidden_state
        
        # Concatena input com hidden state anterior
