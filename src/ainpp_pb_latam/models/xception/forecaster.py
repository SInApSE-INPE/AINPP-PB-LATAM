...
import timm
from ainpp_pb_latam.models.xception.blocks import Up
...
class XceptionMultiHorizon(nn.Module):
    def __init__(self, input_timesteps=12, output_timesteps=6, pretrained=True):
        ...
        # features_only: returns a feature list [f0, f1, f2, f3, f4]
        # out_indices: ensures we get the outputs from the 5 stages (strides 2, 4, 8, 16, 32)
